loadParameters <- function( context ) {
  ...
  # parms <- c( AP_minimum_sampling_frequency=20000,AP_correlationWindow=1*1E6,AP_blackout=10E3,AP_CCthreshold=0.95,AP_EDthreshold=1.5,list(AP_waveform_mask=seq(-6,25)),AP_computation_mask=list(seq(15,30)),AP_database_update_limit=100,AP_filter_detect_lowF=600,AP_filter_detect_highF=6000,AP_filter_keep_lowF=600,AP_filter_keep_highF=6000,AP_signalType="AP",
  ...
  if ( context$signalType=="AP" ) { # AP
    parms <- c(minimum_sampling_frequency=unname(parms['AP_minimum_sampling_frequency']),correlationWindow=unname(parms['AP_correlationWindow']),blackout=unname(parms['AP_blackout']),CCthreshold=unname(parms['AP_CC_threshold']),EDthreshold=unname(parms['AP_ED_threshold']),waveform_mask=unname(parms['AP_waveform_mask']),computation_mask=unname(parms['AP_computation_mask']),database_update_limit=unname(parms['AP_database_update_limit']),filter_detect_lowF=unname(parms['AP_filter_detect_lowF']),filter_detect_highF=unname(parms['AP_filter_detect_highF']),filter_keep_lowF=unname(parms['AP_filter_keep_lowF']),filter_keep_highF=unname(parms['AP_filter_keep_highF']),signalType=unname(parms['AP_signalType']))
  } else if ( context$experiment!="NeuroVista" & context$signalType=="IIS" ) { # home
    parms <- c(minimum_sampling_frequency=unname(parms['IIS_minimum_sampling_frequency']),correlationWindow=unname(parms['IIS_correlationWindow']),blackout=unname(parms['IIS_blackout']),CCthreshold=unname(parms['IIS_CC_threshold']),EDthreshold=unname(parms['IIS_ED_threshold']),waveform_mask=unname(parms['IIS_waveform_mask']),computation_mask=unname(parms['IIS_computation_mask']),database_update_limit=unname(parms['IIS_database_update_limit']),filter_detect_lowF=unname(parms['IIS_filter_detect_lowF']),filter_detect_highF=unname(parms['IIS_filter_detect_highF']),filter_keep_lowF=unname(parms['IIS_filter_keep_lowF']),filter_keep_highF=unname(parms['IIS_filter_keep_highF']),signalType=unname(parms['IIS_signalType']))
  } else if ( context$experiment=="NeuroVista" & context$signalType=="IIS" ) { # home
    parms <- c(minimum_sampling_frequency=unname(parms['NV_minimum_sampling_frequency']),correlationWindow=unname(parms['NV_correlationWindow']),blackout=unname(parms['NV_blackout']),CCthreshold=unname(parms['NV_CC_threshold']),EDthreshold=unname(parms['NV_ED_threshold']),waveform_mask=unname(parms['NV_waveform_mask']),computation_mask=unname(parms['NV_computation_mask']),database_update_limit=unname(parms['NV_database_update_limit']),filter_detect_lowF=unname(parms['NV_filter_detect_lowF']),filter_detect_highF=unname(parms['NV_filter_detect_highF']),filter_keep_lowF=unname(parms['NV_filter_keep_lowF']),filter_keep_highF=unname(parms['NV_filter_keep_highF']),signalType=unname(parms['NV_signalType']))
  } else {
