overlayLinePlots <- function( df ) {
  # Assumes a data frame with two fields: 'time' and 'voltage'
  #
  ...
  # df <- as.data.frame( cbind( time=as.character(T), voltage=Dl ) )
