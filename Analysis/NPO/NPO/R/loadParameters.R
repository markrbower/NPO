loadParameters <- function( context ) {
  ...
  # parms <- c( AP_minimum_sampling_frequency=20000,AP_correlationWindow=1*1E6,AP_blackout=10E3,AP_CCthreshold=0.5,AP_EDthreshold=1.5,list(AP_waveform_mask=seq(-6,25)),AP_computation_mask=list(seq(15,30)),AP_database_update_limit=100,AP_filter_detect_lowF=600,AP_filter_detect_highF=6000,AP_filter_keep_lowF=600,AP_filter_keep_highF=6000,AP_signalType="AP",
